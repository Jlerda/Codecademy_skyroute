...
stations_under_construction = ['Stadium-Chinatown', 'Marine Drive', 'Royal Oak']
...
def set_start_and_end(start_point, end_point):
  if start_point:
    change_point = str(input("What would you like to change? You can enter 'o' for 'origin', 'd' for 'destination', or 'b' for 'both': "))
    if change_point == "b":
